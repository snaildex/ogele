...
{
	flags |= ImGuiInputTextFlags_CharsScientific;
	return InputScalarN(label, ImGuiDataType_Double, v, 2, NULL, NULL, "%f", flags);
}

bool ImGui::InputDouble3(const char* label, double v[3], const char* format, ImGuiInputTextFlags flags)
{
	flags |= ImGuiInputTextFlags_CharsScientific;
	return InputScalarN(label, ImGuiDataType_Double, v, 3, NULL, NULL, "%f", flags);
}

bool ImGui::InputDouble4(const char* label, double v[4], const char* format, ImGuiInputTextFlags flags)
{
	flags |= ImGuiInputTextFlags_CharsScientific;
	return InputScalarN(label, ImGuiDataType_Double, v, 4, NULL, NULL, "%f", flags);
}
