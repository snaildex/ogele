...
void main(){Result=Col;}
	...
	void Application::CreateInternal() {
		m_drawTex = CreateShaderProgram("ScreenDraw", ScreenQuadUVSource, DrawTexFragSource);
		m_drawBasis = CreateShaderProgram("DrawBasis", CoordBasisVertSource, CoordBasisFragSource);
