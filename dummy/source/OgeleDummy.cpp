...
class RunnerApp : public Application {
    ...
    void Update() override {
        ...
        ClearColor({0.4f, 0.6f, 0.8f, 1.0f});
        Clear(BufferBit::Color | BufferBit::Depth);
        //SetPolygonMode(PolygonFace::FrontAndBack,PolygonMode::Line);
        m_terr->Draw(cam.get());
        ...
        ImGui::Begin("", nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoInputs);
        ImGui::Text("Time: %.1f s",GetTime());
